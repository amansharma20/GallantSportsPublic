...
export default function ArenaDetailsScreen(props) {
    ...
    const arenaDetails = props.route.params.arenaDetails
    const lat = arenaDetails.item.Arena.Latitude
    const lng = arenaDetails.item.Arena.Longitude

    // GET ACTIVITY LIST
    const { data: data2 } = useQuery(GQLQuery.GET_ACTIVITY_BY_ARENA_ID, {
        variables: {
            ArenaId: arenaDetails.item.Arena.Id,
        },
    });
        ...
        <View style={{ flex: 1 }}>
            <ScrollView
                ...
                <View>
                    ...
                    <View>
                        <Image source={{ uri: applicationProperties.imageUrl + arenaDetails.item.Arena.ArenaImageStoragePath }} style={{ width: '100%', height: 200 }} />
                    </View>
                    {/* <Carousel
                        active
                        data={IMAGEDATA}
                        ...
                        <View style={styles.mainDetailsContainer}>
                            <View style={styles.headerTopContainer}>
                                <Text style={styles.titleText}>
                                    {arenaDetails.item.Arena.Name}
                                </Text>
                                <View style={styles.ratingContainer}>
                                    <Text style={styles.ratingText}>
                                        {arenaDetails.item.Arena.Rating}
                                    </Text>
                            ...
                            <View style={styles.locationContainer}>
                                <Text style={styles.addressText}>
                                    {arenaDetails.item.Arena.Address}
                                </Text>
                            ...
                            <View style={styles.descriptionContainer}>
                                <Text style={styles.bodyText}>
                                    {arenaDetails.item.Arena.Description}
                                </Text>
                            </View>
